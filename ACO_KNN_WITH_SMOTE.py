    ...
    def optimize(self, X, y):
        ...
        for iteration in range(self.max_iter):
            for individual in population:
                ...
                n_neighbors = int(individual[0] * 10) + 1  # Example: n_neighbors between 1 and 10
                p = individual[1]  # Example: p between 1 and 2
...
# Evaluate the model
metrics = evaluate_model(model, X_res, y_res, cv)
print(f"KNN with SMOTE Metrics: {metrics}")
OUTPUT:
Best Hyperparameters: (4, 2)
Best F1 Score: 0.9172962134918771
KNN with SMOTE Metrics: {'Accuracy': 0.9180404724585759, 'Precision': 0.9286105328174415, 'Recall': 0.9180404724585759, 'F1 Score': 0.9174851608997181, 'ROC AUC': 0.9842536301892157}
